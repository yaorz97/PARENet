...
def make_parser():
    ...
    parser.add_argument("--src_file", default='../../data/demo/src.npy', help="src point cloud numpy file")
    parser.add_argument("--ref_file", default='../../data/demo/ref.npy', help="src point cloud numpy file")
